...
public class AddIfMin extends NetworkCommand {
    public AddIfMin(UPDClient updClient) {
        super(updClient);
    }
    ...
    public void execute(String[] args) throws WrongAmountOfArgumentsException, IOException {
        ...
        Response receivedResponse = client.sendAndReceive(new AddIfMinRequest(ticket));
        AddIfMinResponse response = handleResponse(receivedResponse, AddIfMinResponse.class);
